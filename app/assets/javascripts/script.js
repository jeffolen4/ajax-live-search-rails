...
var ls = {
    ...
    url: "ajax/process_livesearch.json",
    form_id: "#ls_form",
...
function initialize_globals() {
  ...
  query = $(ls.query_id);
  footer = $(ls.footer_id);
  current_page = $(ls.current_page_hidden_id);
  current_page_lbl = $(ls.current_page_lbl_id);
  total_page_lbl = $(ls.last_page_lbl_id);
  page_range = $(ls.page_range_id);
  select_result;
